...
final eliminarMerchandisingUseCaseProvider = FutureProvider.autoDispose
    .family<void, int>((ref, credentials) async {
  final apiClient = ref.read(apiClientProvider);
  final response =
      await apiClient.getData('Merchandising/EliminarMerchandising/$credentials');
