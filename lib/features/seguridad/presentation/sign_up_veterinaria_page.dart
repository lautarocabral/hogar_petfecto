...
class SignUpVeterinariaPageState extends State<SignUpVeterinariaPage> {
  ...
  final _formVeterinariaKey = GlobalKey<FormState>();
              ...
              children: [
                ...
                Center(
                  child: ElevatedButton(
                    onPressed: () {
                      if (selectedLocation != null) {
                        if (_formVeterinariaKey.currentState?.validate() ??
                            false) {
                          var veterinariaModel = VeterinariaModel(
                            nombre: clinicNameController.text,
                            latitud: selectedLocation!.latitude,
                            longitud: selectedLocation!.longitude,
                            telefono: phoneController.text,
                            direccionLocal: addressController.text,
                            suscripciones: [],
                          );
                          context.push(
                    ...
                    style: ElevatedButton.styleFrom(
                      minimumSize: const Size(
                          double.infinity, 50), // Botón ancho completo
